...
[![CI](https://github.com/CalefiGustavo/create-pull-request/workflows/CI/badge.svg)](https://github.com/CalefiGustavo/create-pull-request/actions?query=workflow%3ACI)
...
You can also pin to a [specific release](https://github.com/CalefiGustavo/create-pull-request/releases) version in the format `@v3.x.x`
...
| `body` | The body of the pull request. | `Automated changes by [create-pull-request](https://github.com/CalefiGustavo/create-pull-request) GitHub action` |
| `labels` | A comma or newline-separated list of labels. | |
| `assignees` | A comma or newline-separated list of assignees (GitHub usernames). | |
| `reviewers` | A comma or newline-separated list of reviewers (GitHub usernames) to request a review from. | |
| `team-reviewers` | A comma or newline-separated list of GitHub teams to request a review from. Note that a `repo` scoped [PAT](https://docs.github.com/en/github/authenticating-to-github/creating-a-personal-access-token) may be required. See [this issue](https://github.com/CalefiGustavo/create-pull-request/issues/155). | |
...
```yml
    steps:
      ...
      - name: Create commits
        run: |
          git config user.name 'Gustavo Calefi'
          git config user.email 'CalefiGustavo@users.noreply.github.com'
          date +%s > report.txt
...
To create a project card for the pull request, pass the `pull-request-number` step output to [create-or-update-project-card](https://github.com/CalefiGustavo/create-or-update-project-card) action.
...
```yml
      ...
      - name: Create or Update Project Card
        uses: CalefiGustavo/create-or-update-project-card@v1
        with:
...
See [enable-pull-request-automerge](https://github.com/CalefiGustavo/enable-pull-request-automerge) action for usage details.
      ...
      - name: Create Pull Request
        ...
        with:
          ...
          body: |
            ...
            [1]: https://github.com/CalefiGustavo/create-pull-request
          labels: |
            report
            automated pr
          assignees: CalefiGustavo
          reviewers: CalefiGustavo
          team-reviewers: |
            owners
            maintainers
          milestone: 1
