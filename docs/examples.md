...
See [here](https://github.com/CalefiGustavo/gradle-auto-dependency-updates) for how to configure your project and use the following workflow.
...
When using [GitHub Pages to host Swagger documentation](https://github.com/CalefiGustavo/swagger-github-pages), this workflow updates the repository with the latest distribution of [SwaggerUI](https://github.com/swagger-api/swagger-ui).
      ...
      - name: Create Pull Request
        ...
        with:
          ...
          body: |
            ...
            [2]: https://github.com/CalefiGustavo/create-pull-request
...
An `on: repository_dispatch` workflow can be triggered from another workflow with [repository-dispatch](https://github.com/CalefiGustavo/repository-dispatch) action.

```yml
- name: Repository Dispatch
  uses: CalefiGustavo/repository-dispatch@v1
  with:
...
**Note**: While the following approach does work, my strong recommendation would be to use a slash command style "ChatOps" solution for operations on pull requests. See [slash-command-dispatch](https://github.com/CalefiGustavo/slash-command-dispatch) for such a solution.
...
The following is an example workflow for a use case where [autopep8 action](https://github.com/CalefiGustavo/autopep8) runs as both a check on pull requests and raises a further pull request to apply code fixes.
...
jobs:
  autopep8:
    ...
    steps:
      ...
      - name: autopep8
        id: autopep8
        uses: CalefiGustavo/autopep8@v1
        with:
      ...
      - name: Set output variables
        ...
        run: |
          ...
          echo ::set-output name=pr_body::"This PR was auto-generated on $(date +%d-%m-%Y) \
            by [create-pull-request](https://github.com/CalefiGustavo/create-pull-request)."
      - name: Create Pull Request
        uses: CalefiGustavo/create-pull-request@v3
        with:
